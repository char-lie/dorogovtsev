...
Также можно доказать более сильную теорему
...
Мы знаем, что $F'=p$, но для $F_n$ её производная почти везде будет равна нулю
...
$I_j$ --- полуинтервалы ненулевой длины, покрывающие весь промежуток
