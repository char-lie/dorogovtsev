...
Функция $q$ в свою очередь сходится к $p$, так как приблизительно равно
...
\end{example}
\begin{theorem}
    \index{теорема!о существовании!состоятельной оценки}
    Пусть функция $\varphi\left( x \right)$
    в \eqref{eq:unknown_parameter} непрерывна, ограничена и строго монотонна.
