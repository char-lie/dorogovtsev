...
Зато можно теперь можно попытаться распространить эту функцию
...
\begin{lemma}[Равенство скалярных произведений]
    ...
    $$\varphi^{\eta}\left( \xi \right)
        = \left. \mean{\left( \eta \mid \xi=x \right)} \right|_{x=\xi}$$
...
\begin{enumerate}[label=\bfseries Формулировка \arabic*:]
    \item \textit{(простая)}
        ...
        $$\int\limits_A \integralc{\Omega}{}{\probability{d\tilde{\omega}}}{
                \eta \cdot \indicatorof{d\omega} \cdot}
                = \int\limits_A \integralc{d\omega}{}
    ...
    \item \textit{(магия определений)}
        ...
        при появлении почти любого события из $d\omega$
...
\begin{equation}\label{phiIntegral}
    \varphi^{\eta}\left( x \right)
        = \frac{\integral{\mathbb{R}}{}{y}{y \cdot \pdf{x,y} \cdot}}
            {r\left( x \right)}
        = \frac{\integral{\mathbb{R}}{}{y}{y \cdot \pdf{x,y} \cdot}}
...
\begin{lemma}[Равенство скалярных произведений
    ...
    Тогда функция
    $$\varphi^{\eta}\left( \xi \right)
        = \left. \frac{\integral{\mathbb{R}}{}{y}{y \cdot \pdf{x,y} \cdot}}
...
$$\integral{\mathbb{R}}{}{y}{ \integral{\mathbb{R}}{}{x}{
    \varphi^{\eta}\left( x \right) \cdot \indicator{x \in \Delta}
        \cdot \pdf{x,y} \cdot} \cdot}
    = \integral{\Delta}{}{x}{
        \varphi^{\eta}\left( x \right) \cdot r\left( x \right) \cdot}$$
...
$$\integral{\Delta}{}{x}{\left(
        ...
        \cdot r\left( x \right) \right)}
    =\integral{\Delta}{}{x}{
        \integral{\mathbb{R}}{}{y}{y \cdot \pdf{x,y} \cdot} \cdot}$$
...
которые позволят облегчить процедуру вычисления
\cite[стр.~270]{Shiryayev1}, \cite[стр.~143]{BorovkovMS}

\begin{enumerate}
    \item Равенство скалярных произведений (формула полной вероятности)
