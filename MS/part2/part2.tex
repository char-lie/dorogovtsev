...
\begin{enumerate}
    \item $\tilde{\eta}$ --- случайная величина,
    ...
    \item Когда $\omega$ принадлежит $H_k$,
        ...
        на событии $H_k$.
        Индикатор в математическом ожидании даёт значения лишь в пределах $H_k$,
        а вероятность $H_k$ в знаменателе масштабирует результат
        (как в формуле условной вероятности)
\end{enumerate}

Забегая наперёд,
введём небольшое определение условного математического ожидания,
чтобы обратить внимание на этот важный момент.
\begin{definition}[Условное математическое ожидание
    случайной величины относительно алгебры]
    \index{условное математическое ожидание}
    \index{математическое ожидание!условное}
    Имеется $\sigma$-алгебра $\mathfrak{F}$,
    порождённая дискретной случайной величиной, разбитая на $n$ уровней
    $H_1, H_2, \dots, H_n$.
    ...
    которая обозначается $\mean{\left[ \eta \mid \mathfrak{F} \right]}$
    и вычисляется по формуле
    $$\mean{\left[ \eta \mid \mathfrak{F} \right]}
        = \sum_{k=1}^n
            \frac{\mean{\left( \eta \cdot \indicatorof{H_k} \right)}}
                {\probability{H_k}}
            \cdot \indicatorof{H_k}$$
