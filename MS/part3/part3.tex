...
\subsection{Свойства ковариационной матрицы случайного вектора}
...
Но что же происходит, когда матрица $\operatorname{A}$ вырождена?
...
Пришло время начать изучение ковариационной матрицы двух разных случайных
векторов.
