...
\begin{enumerate}
    ...
    \item\label{item:covMatrix:property:linearityR}
        ...
        $$\Cov{\alpha}{\operatorname{D} \beta}
            = \Cov{\alpha}{\beta} \operatorname{D^T}$$
    \item Следствие из свойств \ref{item:covMatrix:property:linearityL} и
...
Таким образом, если $\vec{\xi} \circ \vec{\eta}$ --- гауссовский вектор, то
следующее вектора независимы
$$\vec{\alpha}
    = \vec{\xi} - \Cov{\vec{\xi}}{\vec{\eta}} \dCov[-1]{\vec{\eta}} \vec{\eta},
\qquad \vec{\beta} = \vec{\eta}$$
