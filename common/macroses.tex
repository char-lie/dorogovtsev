...
\mdtheorem[style=theoremstyle]{lemma}{Лемма}[theorem]
\mdtheorem[style=theoremstyle]{affirmation}{Утверждение}[theorem]
\mdtheorem[style=remarkstyle]{remark}{Замечание}[theorem]
...
\mdtheorem[style=theoremstyle]{definition}{Определение}[theorem]
\mdtheorem[style=examplestyle]{example}{Пример}[theorem]
