...
% Integral by R
% #1: differential argument
% #2: integrand
\newcommand{\integralr}[2]{\integral{\mathbb{R}}{}{#1}{#2}}
...
\newcommand{\xsample}[1][n]{$x_1$, $\dots$, $x_{#1}$~}
\newcommand{\xwsample}[1][n]{$x_1\left( \omega \right)$,
  $\dots$, $x_{#1}\left( \omega \right)$~}
